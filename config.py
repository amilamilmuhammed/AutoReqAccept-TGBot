...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get('BOT_TOKEN',8196038845:AAGA8OejoFEq23qrrQZ-Qn7kkmv24Yh4s5M'') # ⚠️ Required
    ...
    # Other Config 
    BOT_USERNAME = os.environ.get("BOT_USERNAME", @kavitha1_bot"") # ⚠️ Required
